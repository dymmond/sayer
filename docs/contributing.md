...
It is natural that you might find something that Sayer should support or even experience some sorte of unexpected
...
```shell
$ git clone https://github.com/YOUR-USERNAME/sayer
```

sayer also uses [hatch](https://hatch.pypa.io/latest/) for its development, testing and release
cycles.
...
Because Sayer uses pytest, any additional arguments will be passed. More info within the
...
*This section is for the maintainers of `Sayer`*.

### Building the Sayer for release
